...
func introduceMyself() {
    print("Hi there. My name is Sergey and I'm really glad to meet you!")
}
...
func magicEightBall() {
    ...
    switch randomNum {
    case 0:
        print("\(randomNum) gravity")
    case 1:
        print("\(randomNum) is such a lonely number")
    case 2:
        print("\(randomNum) and \(randomNum) equals 4. That's easy.")
    case 3:
        print("\(randomNum) as a bird")
    case 4:
        print("one \(randomNum) all and all \(randomNum) one")
    case 5:
        print("Give me high \(randomNum)")
    default:
        print("There is nothing to lose")
    }

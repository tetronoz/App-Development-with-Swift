 ...
 */
var walkingChallenges: Array<String> = ["Walk 3 miles a day", "Walk 30 miles a week"]
var runningChallenges: Array<String> = ["Run 10 miles a day", "Run 45 miles a week"]
/*:
...
if committedChallenges.isEmpty {
    print("Please, choose a new challenge")
